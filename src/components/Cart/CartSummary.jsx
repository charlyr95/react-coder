            ...
            <div className="card border-0 shadow-sm cart-summary">
              ...
              <div className="card-body">
                <div className="d-flex justify-content-between mb-2">
                  <span>Subtotal (<span id="cartProductsCount">0</span> productos)</span>
                ...
                <div className="row row-cols-2 g-2 mb-4">
                  <div className="col">
                    <div className="card payment-method-card active h-100">
                ...
                <div className="text-center">
                  <small className="text-muted">
                    Al finalizar aceptas nuestros <a href="#" className="text-decoration-none">términos y condiciones</a>
                  </small>
                </div>
              </div>
            </div>
